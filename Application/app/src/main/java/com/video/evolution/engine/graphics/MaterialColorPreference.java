...
import com.video.evolution.engine.graphics.ColorPalette;
...
public class MaterialColorPreference extends Preference {
    ...
    public static class ColorDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            int color = Settings.getPrimaryColor();
            if(colorType == 0){
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if(colorType == 0) {
							...
							Settings.setAccentColor(ColorPalette.getAccentColor(context, mColorPicker.getColor()));
						} else if (colorType == 1) {
            ...
            builder.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						if(colorType == 0) {
							((SettingsActivity)getActivity()).changeActionBarColor(Settings.getPrimaryColor());
						}
						dismiss();
					}
				});
    ...
    private static void setColorViewValue(View view, int color, boolean selected) {
        if (view instanceof ImageView) {
            ...
            if (selected) {
                ...
                InsetDrawable checkmarkInset = new InsetDrawable(checkmark, Api.dpToPx(5));
